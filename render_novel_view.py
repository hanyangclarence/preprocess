...
def render_forward_splat(src_imgs, src_depths,
                           r_cam, t_cam, k_src,
                           k_dst):
    ...
    pts_3d_tgt = rot[None, None, None, Ellipsis] @ pts_3d_ref + t[None, None, None, :, None]
...
t_target = torch.tensor([-0.5, 0.5, 1.0])

warp_feature, warp_disp, warp_mask = render_forward_splat(img, depth_map[None, ...], R_target, t_target, K, K)
