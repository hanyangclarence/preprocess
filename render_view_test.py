...
if __name__ == '__main__':
    img_path = '../dataset/neural_3d_video/coffee_martini/scans/frame0001/images/00000000.jpg'
    depth_path = '../dataset/neural_3d_video/coffee_martini/scans/frame0001/depth_est/00000000.pfm'
    source_cam_path = '../dataset/neural_3d_video/coffee_martini/scans/frame0001/cams/00000000_cam.txt'
    camera_pose_dir = '../dataset/neural_3d_video/coffee_martini/scans/frame0001/cams'
    ...
    R_source, t_source, (h, w, f) = get_camera_parameters_from_colmap(source_cam_path)
    ...
    cam_list = [s for s in cam_list if s != '00000000_cam.txt']
